...
number.5.Guitar.Music_Voice.1 = {
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % [Guitar.Music_Voice.1 measure 31]
            % BEFORE:
            % COMMANDS:
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.1 measure 31]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
...
number.5.Guitar.Music_Voice.2 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.2 measure 10]
            % BEFORE:
            % COMMANDS:
            \set stemLeftBeamCount = 0
            \set stemRightBeamCount = 3
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.2 measure 24]
            % BEFORE:
            % COMMANDS:
              %! baca.OverrideCommand._call(1)
              %! baca.stem_up()
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.2 measure 25]
    % BEFORE:
    % COMMANDS:
      %! baca.OverrideCommand._call(1)
      %! baca.beam_positions()
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.2 measure 31]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.5.Guitar.Music_Voice.3 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 8]
            % BEFORE:
            % COMMANDS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.3 measure 14]
      %! baca.make_music()
    s1 * 63/160
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 22]
            % BEFORE:
            % COMMANDS:
            \set stemLeftBeamCount = 2
            \set stemRightBeamCount = 1
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.3 measure 23]
      %! baca.make_music()
    s1 * 207/160
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 29]
              %! baca.make_music()
            a16
            % AFTER:
            % ARTICULATIONS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.3 measure 30]
      %! baca.make_music()
    s1 * 3/20
    % AFTER:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.3 measure 31]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.5.Guitar.Music_Voice.4 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.4 measure 14]
            % BEFORE:
            % COMMANDS:
            \set stemLeftBeamCount = 1
            \set stemRightBeamCount = 2
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.4 measure 28]
              %! baca.make_music()
            c''16
            % AFTER:
            % ARTICULATIONS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.4 measure 29]
      %! baca.make_music()
    s1 * 1/16
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.4 measure 31]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
