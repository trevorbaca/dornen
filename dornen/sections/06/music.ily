    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.1 measure 14]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.2 measure 14]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 2]
              %! baca.make_music()
            f16
            % AFTER:
            % ARTICULATIONS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 6]
              %! baca.make_music()
            a16
            % AFTER:
            % ARTICULATIONS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.3 measure 14]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.4 measure 14]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
