...
number.7.Guitar.MusicVoice.2 = {
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.MusicVoice.2 measure 16]
      %! baca.make_music()
    s1 * 1/8
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.2 measure 17]
            % BEFORE:
            % COMMANDS:
            \set stemLeftBeamCount = 2
            \set stemRightBeamCount = 1
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.MusicVoice.2 measure 18]
      %! baca.make_music()
    s1 * 1/8
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Guitar.MusicVoice.3 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.3 measure 20]
            % BEFORE:
            % COMMANDS:
              %! baca.OverrideCommand._call(1)
              %! baca.stem_up()
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.MusicVoice.3 measure 21]
      %! baca.make_music()
    s1 * 1/6
    % AFTER:
    % COMMANDS:
