    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.1 measure 23]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
...
number.7.Guitar.Music_Voice.2 = {
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.2 measure 18]
      %! baca.make_music()
    s1 * 1/8
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.2 measure 23]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.7.Guitar.Music_Voice.3 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.Music_Voice.3 measure 7]
            % BEFORE:
            % COMMANDS:
              %! baca.OverrideCommand._call(1)
              %! baca.stem_up()
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.3 measure 15]
      %! baca.make_music()
    s1 * 3/8
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Guitar.Music_Voice.3 measure 21]
      %! baca.make_music()
    s1 * 1/6
    % AFTER:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.3 measure 23]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.Rest_Voice.4 measure 23]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
