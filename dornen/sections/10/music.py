...
def postprocess(cache):
    ...
    with baca.scope(m[2]) as o:
        baca.spanners.hairpin(o, "ppp < pp", rleak=True)
    with baca.scope(m[4]) as o:
        baca.spanners.hairpin(o, "pp > ppp", rleak=True)
    with baca.scope(m[7]) as o:
        baca.spanners.hairpin(o, "ppp < p", rleak=True)
    with baca.scope(m[9]) as o:
        baca.spanners.hairpin(o, "p > ppp", rleak=True)
