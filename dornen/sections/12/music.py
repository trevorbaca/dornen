...
def postprocess(cache):
    ...
    with baca.scope(m[4]) as o:
        baca.hairpinlib.exact(o, "mp>p", rleak=True)
        baca.mspanners.text([o], "trans. => tamb. tr.")
    with baca.scope(m[7]) as o:
        baca.hairpinlib.exact(o, "p<mf", rleak=True)
        baca.mspanners.text([o], "trans. => kn. rasg.")
    with baca.scope(m[9]) as o:
        baca.hairpinlib.exact(o, "mf>p", rleak=True)
        baca.mspanners.text([o], "trans. => tamb. tr.")
    ...
    with baca.scope(m[20]) as o:
        baca.hairpinlib.exact(o, "p<f", rleak=True)
        baca.mspanners.text([o], "trans. => kn. rasg.")
