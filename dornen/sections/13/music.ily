...
number.13.Guitar.MusicVoice.1 = {
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 32]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 38]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 39]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 40]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 44]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 45]
              %! baca.make_music()
            e2
            % AFTER:
            % STEM_TREMOLOS:
      ...
      %! baca.make_music()
    {
          ...
          %! baca.make_music()
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Guitar.MusicVoice.1 measure 46]
            % BEFORE:
            % COMMANDS:
              %! baca.OverrideCommand._call(1)
              %! baca.text_script_staff_padding()
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % [Guitar.MusicVoice.1 measure 47]
            % BEFORE:
            % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.MusicVoice.2 measure 47]
            % BEFORE:
            % COMMANDS:
              %! INVISIBLE_MUSIC_COMMAND
              %! NOTE
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.MusicVoice.3 measure 47]
            % BEFORE:
            % COMMANDS:
              %! INVISIBLE_MUSIC_COMMAND
              %! NOTE
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Guitar.MusicVoice.4 measure 47]
            % BEFORE:
            % COMMANDS:
              %! INVISIBLE_MUSIC_COMMAND
              %! NOTE
