...
def make_empty_score(first_measure_number, previous_persistent_indicators):
    ...
    with baca.scope([["E2"]]) as collections:
        ...
        baca.label_figure(tuplets, "2_1", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "2_2", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "2_3", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "2_4", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "2_5", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        ...
        baca.label_figure(tuplets, "3_1", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "3_2", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "3_3", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "3_4", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "3_5", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        ...
        baca.label_figure(tuplets, "4_1", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_2", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_3", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_4", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_5", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_6", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_7", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_8", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_9", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_10", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_11", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_12", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_13", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_monads(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_14", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([4 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_15", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([5 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_16", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([4 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_17", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_18", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_19", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_20", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_21", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_22", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([4 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_23", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([5 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_24", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([4 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_25", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_26", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_27", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([1 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_28", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_29", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_30", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([4 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_31", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([5 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_32", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([3 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_33", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([2 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_34", counter)
        library.populate(score, library.v1, tuplets)
    with baca.scope([1 * ["E2"]]) as collections:
        tuplets, tsd = library.make_thirds(collections)
        time_signature = library.time_signature(tuplets, tsd)
        time_signatures.append(time_signature)
        baca.label_figure(tuplets, "4_35", counter)
        library.populate(score, library.v1, tuplets)
    tuplets, tsd = library.make_rests(5, (1, 8))
    time_signature = library.time_signature(tuplets, tsd)
    time_signatures.append(time_signature)
    baca.label_figure(tuplets, "4_36", counter)
    library.populate(score, library.v1, tuplets)
