...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \time 17/64                                                                %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:baca.SegmentMaker._make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:baca.SegmentMaker._attach_color_literal(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \time 7/64                                                                 %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:baca.SegmentMaker._make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:baca.SegmentMaker._attach_color_literal(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    ...
    \time 12/64                                                                %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:baca.SegmentMaker._make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:baca.SegmentMaker._attach_color_literal(2)
    s1 * 3/16                                                                  %! baca.SegmentMaker._make_global_skips(1)
%@% \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER
...
A_Guitar_Music_Voice_I = {                                                     %! abjad.Path.extern

    {
        ...
        %@% \override GuitarMusicStaff.Clef.color = ##f                        %! DEFAULT_CLEF_COLOR_CANCELLATION:baca.SegmentMaker._attach_color_literal(1)
            \set GuitarMusicStaff.forceClef = ##t                              %! DEFAULT_CLEF:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(2):abjad.ScoreTemplate.attach_defaults
            e'8.
        %@% ^ \markup {                                                        %! FIGURE_NAME
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        %@% ^ \baca-duration-multiplier-markup #"1" #"32"                      %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_mutlipliers()
...
A_Guitar_Music_Voice_III = {                                                   %! abjad.Path.extern
...

    {
        ...
        %@%             }                                                      %! FIGURE_NAME
        %@%     }                                                              %! FIGURE_NAME
        %@% ^ \baca-duration-multiplier-markup #"192" #"1024"                  %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_mutlipliers()
            [

            b'64 * 448/1024
        %@% ^ \baca-duration-multiplier-markup #"448" #"1024"                  %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_mutlipliers()
...
A_Guitar_Music_Voice_IV = {                                                    %! abjad.Path.extern
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        %@% ^ \baca-duration-multiplier-markup #"7" #"64"                      %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_mutlipliers()
