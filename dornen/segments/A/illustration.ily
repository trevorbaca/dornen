...
A_Guitar_Music_Voice_I = {                                                     %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7)
        ...
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):INVISIBLE_MUSIC:HIDDEN_NOTE
            c''1 * 1/32                                                        %! baca.SegmentMaker._make_multimeasure_rest_container(1):HIDDEN_NOTE
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6)
            ...
            s1 * 1/32                                                          %! baca.SegmentMaker._make_multimeasure_rest_container(5)
...
A_Guitar_Music_Voice_IV = {                                                    %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7)
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(4)
            ...
            \baca-invisible-music-coloring                                     %! baca.SegmentMaker._make_multimeasure_rest_container(2):INVISIBLE_MUSIC_COLORING:HIDDEN_NOTE
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):INVISIBLE_MUSIC:HIDDEN_NOTE
            c''1 * 7/64                                                        %! baca.SegmentMaker._make_multimeasure_rest_container(1):HIDDEN_NOTE
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6)
            ...
            s1 * 7/64                                                          %! baca.SegmentMaker._make_multimeasure_rest_container(5)
