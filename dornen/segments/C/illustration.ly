    ...
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            \context GlobalSkips = "GlobalSkips" {
                ...
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 32) % SEGMENT:SPACING:COMMAND:5
                s1 * 11/32
                %%% ^ \markup { % CLOCK_TIME:7
                                ...
                                %%% { % SEGMENT:SPACING:MARKUP:6
                                    %%% \with-color % SEGMENT:SPACING:MARKUP:6
                                        ...
                                        %%% \fontsize % SEGMENT:SPACING:MARKUP:6
                                            ...
                                            %%% (32/1024) % SEGMENT:SPACING:MARKUP:6
                                %%% } % SEGMENT:SPACING:MARKUP:6
                        }
                    }
                ...
                \time 11/64
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 64) % SEGMENT:SPACING:COMMAND:2
                s1 * 11/64
                %%% ^ \markup { % CLOCK_TIME:4
                                ...
                                %%% { % SEGMENT:SPACING:MARKUP:3
                                    %%% \with-color % SEGMENT:SPACING:MARKUP:3
                                        ...
                                        %%% \fontsize % SEGMENT:SPACING:MARKUP:3
                                            ...
                                            %%% (16/1024) % SEGMENT:SPACING:MARKUP:3
                                %%% } % SEGMENT:SPACING:MARKUP:3
                        }
                    }
                            ...
                            %%% \line % SEGMENT:SPACING:MARKUP:3
                                %%% { % SEGMENT:SPACING:MARKUP:3
                                    %%% \with-color % SEGMENT:SPACING:MARKUP:3
                                        ...
                                        %%% \fontsize % SEGMENT:SPACING:MARKUP:3
                                            %%% #-3 % SEGMENT:SPACING:MARKUP:3
                                            %%% (32/1024) % SEGMENT:SPACING:MARKUP:3
                                %%% } % SEGMENT:SPACING:MARKUP:3
                        }
                    }
                ...
                \time 3/16
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 3 256) % SEGMENT:SPACING:COMMAND:2
                s1 * 3/16
                %%% ^ \markup { % CLOCK_TIME:4
                    %%% \fontsize % CLOCK_TIME:4
                        %%% #-2 % CLOCK_TIME:4
                            ...
                            %%% \line % SEGMENT:SPACING:MARKUP:3
                                %%% { % SEGMENT:SPACING:MARKUP:3
                                    %%% \with-color % SEGMENT:SPACING:MARKUP:3
                                        ...
                                        %%% \fontsize % SEGMENT:SPACING:MARKUP:3
                                            %%% #-3 % SEGMENT:SPACING:MARKUP:3
                                            %%% (3/256) % SEGMENT:SPACING:MARKUP:3
                                %%% } % SEGMENT:SPACING:MARKUP:3
                        }
                    }
                ...
                \time 9/64
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 96) % SEGMENT:SPACING:COMMAND:2
                s1 * 9/64
                %%% ^ \markup { % CLOCK_TIME:4
                    %%% \fontsize % CLOCK_TIME:4
                        %%% #-2 % CLOCK_TIME:4
                ...
                \time 5/32
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 80) % SEGMENT:SPACING:COMMAND:2
                s1 * 5/32
                %%% ^ \markup { % CLOCK_TIME:4
                    %%% \fontsize % CLOCK_TIME:4
                        %%% #-2 % CLOCK_TIME:4
