...
segment_maker(
    ...
    baca.hairpins(['mp < mf'], selector=baca.select().leaves(leak=Right)),
...
segment_maker(
    ...
    baca.hairpins(['mf > mp'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.tamb_tr(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['mp < f'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.kn_rasg(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['mp < ff'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.kn_rasg(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['ff > mf'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 16),
    baca.hairpins(['mf < f'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
...
segment_maker(
    ...
    baca.hairpins(['f > mf'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.kn_rasg(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['mf < ff'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.nail_rasg(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['mf < ffff'], selector=baca.select().leaves(leak=Right)),
    baca.transition_spanner(
        baca.markup.trans(),
        baca.markup.nail_rasg(),
        baca.select().leaves(leak=Right),
...
segment_maker(
    ...
    baca.hairpins(['ffff > ff'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 28),
    baca.hairpins(['ff < fff'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 29),
    baca.hairpins(['fff > f'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 30),
    baca.hairpins(['f < ff'], selector=baca.select().leaves(leak=Right)),
    )
...
segment_maker(
    ...
    baca.hairpins(['mp > pp'], selector=baca.select().leaves(leak=Right)),
    )
...
segment_maker(
    ...
    baca.hairpins(['pp > pppp'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 42),
    baca.hairpins(['pppp < ppp'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 43),
    baca.hairpins(['ppp > ppppp'], selector=baca.select().leaves(leak=Right)),
    )

segment_maker(
    baca.scope('Guitar Music Voice 1', 44),
    baca.hairpins(['ppppp < pppp'], selector=baca.select().leaves(leak=Right)),
    )
