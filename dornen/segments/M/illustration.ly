                    ...
                    {
                        {
                            ...
                            \set GuitarMusicStaff.shortInstrumentName = \markup { %! REAPPLIED_INSTRUMENT_COMMAND:9
                                \null %! REAPPLIED_INSTRUMENT_COMMAND:9
                                } %! REAPPLIED_INSTRUMENT_COMMAND:9
