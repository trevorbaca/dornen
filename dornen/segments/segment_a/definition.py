...
accumulator(
    accumulator.twentieth_figure_maker(
        ('Guitar Music Voice 2', accumulator.reveal(design[4:5], 1)),
        baca.overrides.beam_positions(-8),
...
accumulator(
    accumulator.running_figure_maker(
        ('Guitar Music Voice 1', design[5:8]),
...
accumulator(
    accumulator.twentieth_figure_maker(
        ('Guitar Music Voice 2', accumulator.reveal(design[4:5], 2)),
        baca.pitch.register(6),
        extend_beam=True,
        figure_name='F1_2',
        ),
...
accumulator(
    accumulator.running_figure_maker(
        ('Guitar Music Voice 1', design[6:9]),
        baca.pitch.register(-14, 0),
        extend_beam=True,
        figure_name='R2',
        ),
...
accumulator(
    accumulator.twentieth_figure_maker(
        ('Guitar Music Voice 2', accumulator.reveal(design[4:5], 3)),
        baca.pitch.register(6),
        extend_beam=True,
        figure_name='F1_3',
        ),
...
accumulator(
    accumulator.running_figure_maker(
        ('Guitar Music Voice 1', design[7:10]),
        baca.pitch.register(-14, 0),
        extend_beam=True,
        figure_name='R3',
        ),
...
accumulator(
    accumulator.twentieth_figure_maker(
        ('Guitar Music Voice 2', accumulator.reveal(design[4:5], 4)),
        baca.pitch.register(6),
        extend_beam=True,
        figure_name='F1_4',
        ),
...
accumulator(
    accumulator.running_figure_maker(
        ('Guitar Music Voice 1', design[8:11]),
        baca.pitch.register(-14, 0),
        extend_beam=True,
        figure_name='R4',
        ),
...
accumulator(
    accumulator.twentieth_figure_maker(
        ('Guitar Music Voice 2', accumulator.reveal(design[4:5], 5)),
        baca.pitch.register(6),
        figure_name='F1',
        ),
    )
...
accumulator(
    accumulator.running_figure_maker(
        ('Guitar Music Voice 1', design[9:13]),
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', design[13:]),
