...
accumulator(
    accumulator.graced_tuplet_figure_maker(
        ('Guitar Music Voice 4', accumulator.reveal(design[5:6], 1)),
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', design[1:2]),
...
accumulator(
    accumulator.graced_tuplet_figure_maker(
        ('Guitar Music Voice 4', accumulator.reveal(design[5:6], 3)),
        baca.overrides.stem_up(),
        baca.pitch.register(0),
        extend_beam=True,
        figure_name='G1_2',
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', accumulator.reveal(cell_d1, 4)),
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', accumulator.reveal(cell_d1, 3)),
        baca.overrides.beam_positions(-6.5),
        baca.overrides.stem_down(),
        extend_beam=True,
        figure_name='D1_2',
...
accumulator(
    accumulator.graced_tuplet_figure_maker(
        ('Guitar Music Voice 4', accumulator.reveal(design[5:6], 5)),
        baca.overrides.stem_up(),
        baca.pitch.register(0),
        extend_beam=True,
        figure_name='G1_5',
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', accumulator.reveal(cell_d1, 10)),
        baca.overrides.beam_positions(-6.5),
        baca.overrides.stem_down(),
        figure_name='D1_3',
        ),
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', accumulator.reveal(cell_d1, 15)),
        baca.overrides.beam_positions(-6.5),
        baca.overrides.stem_down(),
        extend_beam=True,
        figure_name='D1_4',
...
accumulator(
    accumulator.graced_tuplet_figure_maker(
        ('Guitar Music Voice 4', accumulator.reveal(design[5:6], 9)),
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', accumulator.reveal(cell_d1, 6)),
        baca.overrides.beam_positions(-6.5),
        baca.overrides.stem_down(),
        figure_name='D1_5',
        ),
...
accumulator(
    accumulator.graced_tuplet_figure_maker(
        ('Guitar Music Voice 4', accumulator.repeat(design[5:6], n=2)),
        baca.overrides.beam_positions(6),
        baca.overrides.stem_up(),
        baca.pitch.register(0, -14),
        figure_name='G1_8',
...
accumulator(
    accumulator.delicatissimo_figure_maker(
        ('Guitar Music Voice 1', design[6:7]),
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[7:9])),
        baca.pitch.register(-14, -6),
        figure_name='O3',
        ),
    )
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[9:11])),
        baca.overrides.beam_positions(-8),
        baca.pitch.register(-14, -6),
        extend_beam=True,
        figure_name='O4',
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[11:13])),
        baca.pitch.register(-14, -6),
        extend_beam=True,
        figure_name='O5',
        ),
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[13:15])),
        baca.pitch.register(-14, -6),
        extend_beam=True,
        figure_name='O6',
        ),
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[15:17])),
        baca.pitch.register(-14, -6),
        figure_name='O7',
        ),
    )
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[17:19])),
        baca.overrides.beam_positions(-8),
        baca.pitch.register(-14, -6),
        extend_beam=True,
        figure_name='O8',
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', accumulator.merge(design[19:21])),
        baca.pitch.register(-14, -6),
        extend_beam=True,
        figure_name='O9',
        ),
...
accumulator(
    accumulator.ovoid_figure_maker(
        ('Guitar Music Voice 2', design[21:22]),
        baca.pitch.register(-14, -6),
        figure_name='O10',
        ),
    )
