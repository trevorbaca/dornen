    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 2 15) %! SEGMENT:SPACING_COMMAND:3
                        s1 * 7/3
                            - \markup {
                                \column
                                    {
            ...
            <BLANKLINE>
                        ...
                        \time 2/3
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 2 15) %! SEGMENT:SPACING_COMMAND:1
                        s1 * 2/3
