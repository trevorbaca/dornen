    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 70) %! SEGMENT:SPACING_COMMAND:3
                        s1 * 1/4
                            - \markup {
                                \column
                                    {
            ...
            <BLANKLINE>
                        ...
                        \time 2/28
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 70) %! SEGMENT:SPACING_COMMAND:1
                        s1 * 1/14
