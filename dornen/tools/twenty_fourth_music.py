    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60) % SEGMENT:SPACING:COMMAND:3
                        s1 * 7/24
                            - \markup {
                                \column
                                    {
            ...
            <BLANKLINE>
                        ...
                        \time 2/24
                        \newSpacingSection
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60) % SEGMENT:SPACING:COMMAND:1
                        s1 * 1/12
