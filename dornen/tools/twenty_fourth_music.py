    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! HSS1:SPACING
                        \time 7/24                                                         %! SM1:EXPLICIT_TIME_SIGNATURE:SM8
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! HSS1:SPACING
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! HSS1:SPACING
                        \time 2/24                                                         %! SM1:EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! SM1:EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/12
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! HSS1:SPACING
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! HSS1:SPACING
                        \time 3/24                                                         %! SM1:EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! SM1:EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/8
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! HSS1:SPACING
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! HSS1:SPACING
                        \time 4/24                                                         %! SM1:EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! SM1:EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/6
