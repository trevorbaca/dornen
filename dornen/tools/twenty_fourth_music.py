    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! SEGMENT_SPACING:HSS1
                        ...
                        \time 7/24                                                         %! EXPLICIT_TIME_SIGNATURE:SM8
                                            ...
                                            \with-color                                    %! SEGMENT_SPACING_MARKUP:HSS2
                                                ...
                                                \bold                                      %! SEGMENT_SPACING_MARKUP:HSS2
                                                    \fontsize                              %! SEGMENT_SPACING_MARKUP:HSS2
                                                        ...
                                                        (1/60)                             %! SEGMENT_SPACING_MARKUP:HSS2
                                        }                                                  %! SEGMENT_SPACING_MARKUP:HSS2
                                }
                            }
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! SEGMENT_SPACING:HSS1
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! SEGMENT_SPACING:HSS1
                        \time 2/24                                                         %! EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/12
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! SEGMENT_SPACING:HSS1
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! SEGMENT_SPACING:HSS1
                        \time 3/24                                                         %! EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/8
                        ^ \markup {                                                        %! SEGMENT_SPACING_MARKUP:HSS2
                            \with-color                                                    %! SEGMENT_SPACING_MARKUP:HSS2
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! SEGMENT_SPACING:HSS1
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! SEGMENT_SPACING:HSS1
                        \time 4/24                                                         %! EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/6
                        \stopTextSpan                                                      %! SM29
                        ^ \markup {                                                        %! SEGMENT_SPACING_MARKUP:HSS2
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \newSpacingSection                                                 %! SEGMENT_SPACING:HSS1
                        \set Score.proportionalNotationDuration = #(ly:make-moment 1 60)   %! SEGMENT_SPACING:HSS1
                        \time 1/24                                                         %! EXPLICIT_TIME_SIGNATURE:SM8
                        \once \override Score.TimeSignature.color = #(x11-color 'blue)     %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                        s1 * 1/24
                        ^ \markup {                                                        %! SEGMENT_SPACING_MARKUP:HSS2
                            \with-color                                                    %! SEGMENT_SPACING_MARKUP:HSS2
